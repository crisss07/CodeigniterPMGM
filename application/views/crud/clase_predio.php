                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body wizard-content">
                            <div class="col-lg-2 col-md-4">
                                <button <?php echo $verifica['alta']; ?> type="button" class="btn btn-block btn-lg btn-success" data-toggle="modal" data-target="#Modal_insert">Nuevo Clase Predio</button>
                            </div><div class="card">
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a <?php echo $verifica['baja'];?>="<?= base_url('Clase_predio/eliminar/'. $lis->clase_predio_id); ?>" type="button" class="btn btn-danger footable-delete">
