    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ADMINISTRACI&Oacute;N DE TIPO DE PREDIO<?php $i=1; //echo $data['title']; ?>
                        <div class="card-body wizard-content">
                            <div class="col-lg-2 col-md-4">
                                <button <?php echo $verifica['alta']; ?> type="button" class="btn btn-block btn-lg btn-success" data-toggle="modal" data-target="#Modal_insert">Nuevo Tipo Predio</button>
                            </div><div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                   <table id="tabla_din1" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach($tipopredio as $lis){
                                                  $datos = $lis->tipo_predio_id."||".
                                                         $lis->descripcion."||".
                                                         $lis->alias."||".
                                                         $lis->coeficiente;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a <?php echo $verifica['baja'];?>="<?= base_url('Tipopredio/eliminar/'. $lis->tipo_predio_id); ?>" type="button" class="btn btn-danger footable-delete">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel1">Editar Tipo Predio</h4>
                    </div>
                    <div class="modal-body">
                        <!--<form action="<?php echo base_url();?>tipopredio/update" method="POST">-->
                        <?php echo form_open('Tipopredio/update', array('method'=>'POST')); ?>
                             <div class="form-group">
                                <input type="text" hidden="" id="tipo_predio_id" name="tipo_predio_id">
                            </div>
                            <div class="form-group">
        ...
        <div class="modal fade" id="Modal_insert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel1">Insertar Tipo Predio</h4>
                    </div>
                    <div class="modal-body">
                        <!--<form action="<?php echo base_url();?>tipopredio/insertar" method="POST">-->
                        <?php echo form_open('Tipopredio/insertar', array('method'=>'POST')); ?>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Descripci&oacute;n</label>
