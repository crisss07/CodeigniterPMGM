                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body wizard-content">
                            <div class="col-lg-2 col-md-4">
                                <button <?php echo $verifica['alta']; ?> type="button" class="btn btn-block btn-lg btn-success" data-toggle="modal" data-target="#Modal_insert">Nueva Matvia</button>
                            </div><div class="card">
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a <?php echo $verifica['baja'];?>="<?= base_url('Matvia/eliminar/'. $lis->matvia_id); ?>" type="button" class="btn btn-danger footable-delete">
