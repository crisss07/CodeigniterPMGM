    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ADMINISTRACI&Oacute;N DESTINO BLOQUE <?php $i=1; //echo $data['title']; ?>
                        <div class="card-body wizard-content">
                            <div class="col-lg-2 col-md-4">
                                <button <?php echo $verifica['alta']; ?> type="button" class="btn btn-block btn-lg btn-success" data-toggle="modal" data-target="#Modal_insert">Nueva Destino Bloque</button>
                            </div><div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                   <table id="tabla_din1" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach($destino_bloque as $lis){
                                                 $datos = $lis->destino_bloque_id."||".
                                                         $lis->descripcion."||".
                                                         $lis->alias."||".
                                                         $lis->coeficiente;
                                            ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a <?php echo $verifica['baja'];?>="<?= base_url('Destino_bloque/eliminar/'. $lis->destino_bloque_id); ?>" type="button" class="btn btn-danger footable-delete">
