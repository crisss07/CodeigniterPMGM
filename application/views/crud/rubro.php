        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ADMINISTRACI&Oacute;N DE RUBROS <?php $i=1; //echo $data['title']; ?>
                            <div class="card-body wizard-content">
                                ...
                                <div class="col-lg-2 col-md-4">
                                        ...
                                        <button <?php echo $verifica['alta']; ?> type="button" class="btn btn-block btn-lg btn-success" data-toggle="modal" data-target="#Modal_insert">Nueva Rubro</button>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="tabla_din1" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php foreach($rubro as $lis){
                                                    $datos = $lis->rubros_id."||".
                                                            $lis->rubro;
                                                ?>
                                                <tr>
                                                    <td><?php echo $i++;?></td>
                                                    <td><?php echo $lis->rubro;?></td>
                                                    <td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="exampleModalLabel1">Editar rubro</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <?php echo form_open('Rubro/update', array('method'=>'POST', 'id'=>'editar')); ?>
                                ...
                                <div class="form-group">
                                    <input type="text" hidden="" id="rubros_id" name="rubros_id">
                                </div>

                                <div class="form-group">
                                    <label for="recipient-name" class="control-label">Descripci&oacute;n</label>
                                    <input type="text" class="form-control" id="rubro" name="rubro" value="<?php echo $lis->rubro;?>" required="Ingrese rubro"  placeholder="Ingrese rubro...">
            ...
            <div class="modal fade" id="Modal_insert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="exampleModalLabel1">Insertar Nueva Rubro</h4>
                        </div>
                        <div class="modal-body">
                            <!--<form action="<?php echo base_url();?>zona_urbana/insertar" method="POST">-->
                            <?php echo form_open('Rubro/insertar', array('method'=>'POST', 'id'=>'insertar',  'name'=>'informacion')); ?>

                                <div class="form-group">
                                    <label for="recipient-name" class="control-label">Rubro</label>
                                    <input type="text" class="form-control" id="recipient-name1" name="rubro" required="Ingrese rubro"  placeholder="Ingrese rubro...">
                                </div>
