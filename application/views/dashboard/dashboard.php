...
<div class="row">
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="row pt-2 pb-2">
                                        ...
                                        <div class="col pr-0">
                                            ...
                                            <h6 class="text-muted">Usuarios</h6></div>
                                        <!-- Column -->
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="row pt-2 pb-2">
                                        ...
                                        <div class="col pr-0">
                                            ...
                                            <h6 class="text-muted">Tramites</h6></div>
                                        <!-- Column -->
                                        <div class="col text-right align-self-center">
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="row pt-2 pb-2">
                                        ...
                                        <div class="col pr-0">
                                            ...
                                            <h6 class="text-muted">Certificaciones</h6></div>
                                        <!-- Column -->
                                        <div class="col text-right align-self-center">
                ...
                <!-- Row -->
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Recaudaciones por mes</h4>
                                <div>
