                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="ti-bell"></i>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="<?php echo base_url();?>Notificacion/crear">
                                                <div class="btn btn-success btn-circle"><i class="ti-mobile"></i></div>
                                                <div class="mail-contnet">
                                                    <h5>Envio de notificaciones</h5> <span class="mail-desc"></span> <span class="time"></span> </div>
                                            </a>
