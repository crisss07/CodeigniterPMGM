...
<body>
        ...
        <table width="100%" border="0">
            <tr border="0">
                <td align="left" style="width: 15%;" border="0">             
                 <img src="<?php echo base_url(); ?>public/assets/images/reportes/tornologo.png" alt="Logo" width="55" class="logo"/>
             </td>
             <td align="center" >
...
$h=11;
    ...
    <?php print_r($data_grupos[$k+$i]['descripcion']); ?> 
      ...
      <?php 
        ...
        if($h < $total){ ?>
        <td align="justify"  class="titulo" height="0">
        <?php print_r($data_grupos[$h]['descripcion']);?>
      ...
      <?php }?> 
        ...
        <?php 
       $totalg = $num_bloques->total;//total de los items
       $totalg = $totalg-1; 
       ?>
       ...
       <tr>
        ...
        <?php for ($j = 0; $j <= $totalg ; $j++) { ?>
        <?php if($data_grupos[$i]['grupo_mat_id'] == $data_bloques[$j]['grupo_mat_id']){ ?>         
      <td align="justify"  class="columnas" height="0">
      <?php echo $i.'//'; print_r($data_bloques[$j]['descripcion']); 
       ?> 
      </td>
      <td align="justify" class="columnas" height="0">          
      </td>
