            ...
            <div>
                    ...
                    <tr>
                        <td align="center" style="width: 13%;">
                            <div class="col-lg-11 col-md-12">
                                <div class="form-group row" style="font-size: 10px; height: 15px;text-align: right;">
                        ...
                        <td align="center" style="width: 8%;">
                            <div class="col-md-9" style="font-size: 10px; height: 15px;">
         	    ...
         	    <table width="100%">
                    <tr>
                        <td align="left" style="width: 28%;">
                            <h3 style="font-size: 10px; height: 5px;"><b><u>ANTECEDENTES</u></b></h3>
                        </td>
                    </tr>
                </table>                                
               	<table width="100%">
               	...
               	<table width="100%">
                    <tr>
                        <td align="left" style="width: 20%;">
                            <div class="col-lg-11 col-md-12">
                                <div class="form-group row" style="font-size: 10px; height: 15px; text-align: right;">
                                    <label class="control-label text-right col-md-3">SOLICITANTE 1: </label>
                        ...
                        <td align="center" style="width: 15%;">
                            <div class="col-md-9" style="font-size: 10px; height: 15px;">
                                 <input type="text" class="form-control" id="lote" name="lote" size="30" value=" <?php echo $tramite->solicitante1 ?>">
                            </div>
                        </td>
                        ...
                        <td align="center" style="width: 30%;">
                            <div class="col-md-9" style="font-size: 10px; height: 15px;">
                                <input type="text" id="superficie_total" name="superficie_total" size="12" value="<?php echo $tramite->ci1 ?>">
                            </div>
                        </td>                                        
                    </tr>
                    <tr>
                        <td align="left" style="width: 20%;">
                            <div class="col-lg-11 col-md-12">
                                <div class="form-group row" style="font-size: 10px; height: 15px; text-align: right;">
                                    <label class="control-label text-right col-md-3">SOLICITANTE 2: </label>
                    ...
                    <tr>
                        <td align="left" style="width: 28%;">
                            <div style="font-size: 10px; height: 15px; text-align: right;">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td align="center" style="width: 15%;">
                            <div class="col-md-6" style="font-size: 10px; height: 15px;">
               	...
               	<table width="100%">
                    <tr>
                        <td align="left" style="width: 28%;">
                            <h3 style="font-size: 10px; height: 5px;"><b><u>DOCUMENTACION PRESENTADA</u></b></h3>
                        </td>
                    </tr>
                </table>
                <table class="orden" width="100%">
                    <tr>
                        <td align="left" style="width: 28%;">
                            <h3 style="font-size: 10px; height: 5px;"><b>CARNET DE IDENTIDAD</b></h3>         
                        </td>
                    </tr>
                </table>
                <table width="100%">
               	...
               	<table class="orden" width="100%">
                    <tr>
                        <td align="left" style="width: 28%;">
                            <h3 style="font-size: 10px; height: 5px;"><b>FOLIO</b></h3>         
                        </td>
                    </tr>
                </table>
                <table width="100%">
               	...
               	<table class="orden" width="100%">
                    <tr>
                        <td align="left" style="width: 28%;">
                            <h3 style="font-size: 10px; height: 5px;"><b>TESTIMONIO DE PROPIEDAD</b></h3>         
                        </td>
                    </tr>
                </table>
                <table width="100%">
               	...
               	<table width="100%">
                    ...
                    <tr>
                        ...
                        <td align="center" style="width: 72%;">
                            <div style="font-size: 10px; height: 15px; ">
                                <input type="text" id="jurisdicion" name="jurisdicion" size="55" value="<?php echo $tramite->solicitante1 ?>">
                            </div>
                        </td>
                ...
                <table width="100%">
                    <tr>
                        <td align="left" style="width: 28%;">
                            <h3 style="font-size: 10px; height: 5px;"><b><u>CARACTERISTICAS DE LA PROPIEDAD</u></b></h3>
                        </td>
                    </tr>
                </table>
                <table width="100%">
                ...
                <table width="100%">
                    <tr>
                        <td align="left" style="width: 28%;">
                            <h3 style="font-size: 10px; height: 5px;"><b>IMPUESTOS</b></h3>         
                        </td>
                        <td align="center" style="width: 72%;">
                            <div style="font-size: 10px; height: 15px; ">
             	...
             	<table width="100%">
                    <tr>
                        <td align="left" style="width: 28%;">
                            <h3 style="font-size: 10px; height: 5px;"><b>OBSERVACIONES</b></h3>         
                        </td>
                        <td align="center" style="width: 72%;">
                            <div style="font-size: 10px; height: 15px; ">
                ...
                <table width="100%">
                    <tr>
                        <td align="center" style="width: 33%; height: 5px;">
                            <div class="form-group row" style="font-size: 51%; line-height: 50px;">
