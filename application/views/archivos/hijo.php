    ...
    <!--     <?php foreach ($predios as $pre1) {
        ...
        <div class="row"> -->
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Archivos <b> <?php echo $nombre_archivo; ?></b></h4>
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
						  ...
						  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
						    ...
						    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                             ...
                             <?php if ($padre) {  ?>
                            <a class="navbar-brand" href="<?= base_url('Archivos/ingresar/'. $padre); ?>"><button type="button" class="btn btn-warning btn-circle btn-xl" ><i class="fas fa-reply"></i> </button> Atr&aacute;s</a>
                            <?php } else { ?>
                                                ...
                                                <div class="el-card-item card card-body">
                                                    <div class="row">
                                                        <div class="el-card-avatar el-overlay-1 col-md-4 col-lg-3 text-center"> <img src="<?php echo base_url(); ?><?php echo $imagen; ?>" alt="user" class="img-circle img-responsive">
                                                            <div class="el-overlay">
                                                                <ul class="el-info">
                                                                    ...
                                                                    <!-- <li><a class="btn default btn-outline image-popup-vertical-fit" href="<?= base_url('archivo/ingresar/'. $pre->archivo_id); ?>"><i class="icon-share-alt"></i></a></li> -->

                                                                    <!--  -->
                                                                    <!-- <li><a class="btn default btn-outline image-popup-vertical-fit" href="<?= base_url('archivo/ingresarhijo/'. $pre->archivo_id); ?>"><i class="icon-login"></i></a></li>
                                                                    <li><a class="btn default btn-outline" href="javascript:void(0);" data-toggle="modal" data-target="#modalEdicion" onclick="agregarform('<?php echo $datos ?>')"><i class="icon-pencil"></i></a></li>
                                                                    <li><a class="btn default btn-outline" href="<?= base_url('archivo/eliminarhijo/'. $pre->archivo_id); ?>" alt="alert" class="img-responsive model_img" id="sa-params11" onclick="alerta('<?php echo $pre->archivo_id ?>')"><i class="icon-trash"></i></a></li>
                                                                    <li><a class="btn default btn-outline image-popup-vertical-fit" href="<?= base_url('archivo/ingresar/'. $pre->archivo_id); ?>"><i class="icon-share-alt"></i></a></li> -->
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-8 col-lg-9">
                                                            ...
                                                            <small>Propietario: <?php echo $pre->descripcion1; ?></small>
                                                            <br>
                                                            <small>Carnet de Identidad: <?php echo $pre->descripcion2; ?></small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="el-card-item card card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8 col-lg-9">
                                                            ...
                                                            <small>Propietario: <?php echo $pre2->descripcion1; ?></small>
                                                            <br>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                           <?php echo form_open('Archivos/insertarhijo', array('method'=>'POST')); ?>

                                                <div class="form-group">
                                                    <input type="text" hidden="" id="nombre_archivo" name="nombre_archivo" value="<?php echo $nombre_archivo; ?>">
                                                </div>

                                                 <div class="form-group">
                                                    <input type="text" hidden="" id="archivo_id" name="archivo_id" value="<?php echo $archivo_id; ?>">
                                                </div>
                            ...
                            <div id="modalEdicion" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                           <?php echo form_open('Archivos/updateraiz', array('method'=>'POST')); ?>

                                                <div class="form-group">
                                                    <input type="text" hidden="" id="archivo_idc" name="archivo_id" >
                                                </div>
                                                <div class="form-group">
                                                    <label for="recipient-name" class="control-label">Nombre:</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" id="carpetac" name="carpeta">
                            ...
                            <div id="modalPdf" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                           <?php echo form_open_multipart('Archivos/do_upload', array('method'=>'POST')); ?>
    ...
    <script>
        function agregarform(datos)
        {
             d=datos.split('||');
              ...
              $('#padre').val(d[1]);
              $('#nombrec').val(d[2]);
              $('#descripcion1c').val(d[3]);
              $('#descripcion2c').val(d[4]);
              $('#predio_id').val(d[5]);
              $('#nivel').val(d[6]);
              $('#carpetac').val(d[7]);
        }
