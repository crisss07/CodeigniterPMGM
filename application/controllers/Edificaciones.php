...
class Edificaciones extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->userdata("login")) {
            redirect(base_url() . "Edificaciones/nuevo");
        } else {
            redirect(base_url());
        }
    }
    ...
    public function create()
    {
        ...
        if ($this->session->userdata("login")) {
            ...
            redirect(base_url() . 'Edificaciones/nuevo/' . $this->input->post('predio_id') .'/1');
    ...
    public function delete($id = null, $predio_id = null)
    {
        if ($this->session->userdata("login")) {
            ...
            redirect(base_url() . 'Edificaciones/nuevo/' . $predio_id);
        } else {
            redirect(base_url());
        }
    }
    ...
    public function actualizar()
    {
        if ($this->session->userdata("login")) {
            ...
            // fin guardamos los servicios
            redirect(base_url() . 'Edificaciones/nuevo/' . $this->input->post('predio_id'));
        } else {
            redirect(base_url());
        }
    }
